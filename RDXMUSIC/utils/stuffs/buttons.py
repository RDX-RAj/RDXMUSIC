...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("˹CʜᴀᴛGPT˼", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("˹Ǥʀᴏᴜᴘs˼", callback_data="mplus HELP_Group"),InlineKeyboardButton("˹Ƨᴛɪᴄᴋᴇʀs˼", callback_data="mplus HELP_Sticker")],
    ...
    InlineKeyboardButton("˹Ǥᴀᴍᴇs˼", callback_data="mplus HELP_Game"),InlineKeyboardButton("˹Ⓣ-Ǥʀᴀᴘʜ˼", callback_data="mplus HELP_TG")],
