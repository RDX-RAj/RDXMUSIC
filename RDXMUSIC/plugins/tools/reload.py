...
from RDXMUSIC.utils.database import get_assistant, get_authuser_names, get_cmode
from RDXMUSIC.utils.decorators import ActualAdminCB, AdminActual, language
from RDXMUSIC.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await RDX.stop_stream_force(chat_id)
        except:
            pass
