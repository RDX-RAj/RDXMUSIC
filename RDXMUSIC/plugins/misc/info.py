...
bg_path = "RDXMUSIC/assets/userinfo.png"
font_path = "RDXMUSIC/assets/hiroko.ttf"
    ...
    if not message.reply_to_message and len(message.command) == 2:
        try:
            ...
            if user.photo:
                ...
                # User doesn't have a profile photo, use rdx_random_pics directly
                welcome_photo = random.choice(rdx_random_pics)
